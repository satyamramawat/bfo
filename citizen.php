                        ...
                        <div class="col-sm-5 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Sign up panel for CITIZEN </h3>
                            		<p>If you are new to our community please sign-up. </p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" onsubmit="return sub(this)" action="citizensignup.php" method="post" >
...
<!--                                        id="form-about-yourself"-->
                                    ...
                                    <h4>If you are already a user ,then click <a href="citizenlogin.php">here</a> for login panel</h4>
			                    </form>
		                    </div>
                        </div>
                    </div>
